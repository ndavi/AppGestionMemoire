...
@Injectable()
export class SpecialitePopupService {
            ...
            if (id) {
                this.specialiteService.find(id)
                    .subscribe((specialiteResponse: HttpResponse<Specialite>) => {
                        const specialite: Specialite = specialiteResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.specialiteModalRef(component, new Specialite());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    specialiteModalRef(component: Component, specialite: Specialite): NgbModalRef {
