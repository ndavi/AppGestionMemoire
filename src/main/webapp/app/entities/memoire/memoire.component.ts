...
export class MemoireComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.memoireService.query({
            ...
            (res: HttpResponse<Memoire[]>) => this.onSuccess(res.body, res.headers),
    ...
    registerChangeInMemoires() {
        this.eventSubscriber = this.eventManager.subscribe('memoireListModification', (response) => this.reset());
    }
