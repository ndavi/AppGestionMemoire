...
import fr.sciencesu.memoire.repository.TagRepository;
import fr.sciencesu.memoire.service.dto.TagDTO;
import fr.sciencesu.memoire.service.mapper.TagMapper;
import fr.sciencesu.memoire.web.rest.errors.ExceptionTranslator;

import fr.sciencesu.memoire.web.rest.jhipster.TagResource;
...
public class TagResourceIntTest {
    ...
    public void createTag() throws Exception {
        ...
        assertThat(testTag.getNom()).isEqualTo(DEFAULT_NOM);
    }
    ...
    public void updateTag() throws Exception {
        ...
        Tag testTag = tagList.get(tagList.size() - 1);
        assertThat(testTag.getNom()).isEqualTo(UPDATED_NOM);
    }
